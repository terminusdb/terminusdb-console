    ...
    return (
        <Row className={OPTIONS_PANE_CSS} >
            <Col className={OPTIONS_PANE_COL_CSS}>
                <div id={CREATE_CARD.local.id} onClick={props.setLocal} className={CARD_CONTAINER_CSS}>
                    <DatabaseCard card = {CREATE_CARD.local}/>
                </div>
            </Col>

            <Col className={OPTIONS_PANE_COL_CSS}>
                <div id={CREATE_CARD.remote.id} onClick={props.setRemote} className={CARD_CONTAINER_CSS}>                           
