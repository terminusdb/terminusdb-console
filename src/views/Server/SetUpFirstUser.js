...
import { SETUP_FORM, COMMIT_LOG_EXPLANATION_CSS, COMMIT_LOG_EXPLANATION, ADMIN_ACCOUNT_NOTES, 
...
export const SetUpFirstUser = () => {
    ...
    function createAdminUser(deets){
        if(deets.adminid && deets.password && deets.commitlog){
            ...
            TerminusClient.WOQL.lib().add_user(deets.adminid, [deets.commitlog, note, deets.password])
