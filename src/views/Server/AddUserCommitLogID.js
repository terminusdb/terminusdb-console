...
import { COMMIT_LOG_FORM, SETUP_FORM, COMMIT_LOG_EXPLANATION_CSS, JUST_COMMIT_LOG_EXPLANATION, ADMIN_ACCOUNT_NOTES, 
    FAILED_CREATING_ADMIN, CREATED_ADMIN_MESSAGE } from "./constants.server"
...
export const AddUserCommitLogID = () => {
    ...
    function addCommitLogID(deets){
        if(deets.commitlog){
            let q = WOQL.when(
                WOQL.triple("v:User IRI", "terminus:agent_name", woqlClient.user_account())
