//text on top navbar
export const SERVER_HOME_LABEL = 'Home'
export const PROFILE_PAGE_LABEL = 'Profile'
export const NEW_DB_PAGE_LABEL = 'New Database'
export const NEW_TEAM_PAGE_LABEL = 'New Team'
