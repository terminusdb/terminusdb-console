...
export const WARNING_PAGE_CSS = "h-100 connectErrorPage"
export const WARNING_BOX_CSS = "connectLayout"
...
export const UNDER_CONSTRUCTION = {
    ...
    submitButtonClassName: "btn btn-outline-secondary",
    color: "warning",
    ...
    submitText: "Email Us",
    introText: " is not publicly available but is on our roadmap for release. If this is something that you really want, please let us know by sending us an email. Your input can be very influential!",
    headerText: " is currently being tested for public release",
    formWrapperClassName: "under-construction-send-wrapper",
    messagePlaceholder: "Enter your message",
    emailPlaceholder: "Enter your email",
    icon: "tools",
    iconClassName: "mr-3 under-construction-icon",
    headerClassName: 'under-construction-header',
}
