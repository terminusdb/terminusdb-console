const server = process.env.TERMINUSDB_SERVER || `${window.location.protocol}//${window.location.host}/api/`
...
const hub_url = process.env.TERMINUS_HUB_URL || "https://hub-dev-server.dcm.ist/api/" //"https://hub.terminusdb.com/api/" 
