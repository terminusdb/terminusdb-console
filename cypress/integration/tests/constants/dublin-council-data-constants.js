/*
creates dublin council schema
*/

export const DUBLIN_COUNCIL_DATA_SCHEMA_QUERY = 'WOQL.when(true).and(' + '\n' +
    'WOQL.doctype("Party")' + '\n' +
        '.label("Party")' + '\n' +
...
export const DUBLIN_COUNCIL_DATA_WRANGLES = '[WOQL.idgen("doc:Party", ["v:Party_A"], "v:Party_A_ID"),' + '\n' +
...
export const DUBLIN_COUNCIL_DATA_INSERTS = 'WOQL.and(' + '\n' +
...
export const DUBLIN_COUNCIL_SHOW_DOCUMENTS = 'WOQL.limit(1000).and(' + '\n' +
