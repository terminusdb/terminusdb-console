...
module.exports = (env, argv) => ({
  ...
  module: {
    ...
    externals: {
      '@terminusdb-/terminusdb-react-components': {
          root: 'TerminusDBComponents',
          commonjs2: '@terminusdb-/terminusdb-react-components',
          commonjs: '@terminusdb-/terminusdb-react-components',
          amd: 'TerminusDBComponents',
      },
      'react': {
        root: 'React',
        commonjs2: 'react',
